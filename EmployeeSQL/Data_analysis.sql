--List the employee number, last name, first name, sex, salary of each employee
...
--- List the first name, last name, and hire date for the employees who hired in 1986
...
WHERE emp_no IN(
	...
	WHERE de.dept_no IN(
		SELECT dept_no FROM departments d
...
SELECT e.last_name, COUNT(last_name) AS "last name count"
FROM employees e
